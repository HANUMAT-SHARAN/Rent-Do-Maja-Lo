...
import FitnessPro from "./FitnessPro";
...
export default function FitnessSidebar(props) {
...
const SidebarContent = ({ onClose, ...rest }) => {
  const { getFitnessData } = React.useContext(AuthContext);
  ...
  const Checkboxarr = [
    { title: "Tread Mills", id: 1 },
    { title: "Cross Containers", id: 2 },

    { title: "Excercise Bike", id: 3 },
    { title: "Massagers", id: 4 },
  ];
      ...
      <Flex>
        ...
        >
          ...
          >
            ...
            <Button
              onClick={() => [setCheck(1), setCat("treadmill")]}
              color="white"
              bg={"red.500"}
              pr={7}
              pl={7}
